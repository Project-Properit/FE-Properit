...
function signupApi(email, password, phone, first_name, last_name) {
    ...
    return fetch(signupUrl, {
        ...
        body: JSON.stringify({email, password, phone, first_name, last_name}),
    })
...
function* signupFlow(action) {
    try {
        const {email, password, phone, first_name, last_name} = action
        ...
        const response = yield call(signupApi, email, password, phone, first_name, last_name)
