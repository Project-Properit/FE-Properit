...
import { logoutActionNoRedirectToLogin } from "../../actions/logoutActions";
					...
					<div className="content">
						...
						<div id="section_2" style={{height: '600px'}}>
							<p className="descriptionTeam">
								...
								<span
									className="spanText"> Department of Computer Science of the College of Management</span>
...
const mapDispatchToProps = dispatch => ({
	logout: () => dispatch(logoutActionNoRedirectToLogin())
});
